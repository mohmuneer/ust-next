    ...
    >
      <div className="w-full max-w-[900px] flex bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden animate-in">
        <div className="hidden md:flex flex-1 flex-col items-center justify-center p-10 bg-gradient-to-b from-gray-50 to-white border-l border-gray-100">
          ...
          <p className="text-gray-400 text-xs mt-2">بوابة الدخول للدكاترة والموظفين</p>
        </div>

        <div className="flex-[1.2] p-10 flex flex-col justify-center rounded-l-3xl bg-white shadow-[-8px_0_30px_rgba(0,0,0,0.08)]">
          ...
          <h1 className="text-2xl font-bold text-primary-dark text-center mb-1">تسجيل دخول الموظفين</h1>
          <p className="text-sm text-gray-500 text-center mb-8">أدخل الكود الوظيفي وكلمة المرور</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="relative">
              ...
              />
              {errors.employee_code && <p className="text-xs text-danger mt-1">{errors.employee_code.message}</p>}
            </div>
          ...
          <p className="text-center text-[10px] text-gray-300 mt-8">
            جميع الحقوق محفوظة &copy; بوابة الموظفين الإلكترونية 2026
          </p>
        </div>
      </div>
    </div>
