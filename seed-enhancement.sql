...
(1, 3, 'يرجى إرسال جدول الامتحانات لهذا الفصل', 1, '2025-10-05 09:00:00'),
(3, 1, 'تم إرسال الجدول بالبريد الإلكتروني', 1, '2025-10-05 09:15:00'),
(1, 5, 'يرجى متابعة بلاغ الطالب رقم 2024005', 1, '2025-10-10 10:00:00'),
(5, 1, 'تم متابعة البلاغ وجاري الحل', 0, '2025-10-10 10:30:00'),
(2, 4, 'هل تم إضافة درجات الاختبارات الأخيرة؟', 1, '2025-11-05 14:00:00'),
(4, 2, 'نعم، تم الإضافة عبر النظام', 1, '2025-11-05 14:15:00'),
(1, 6, 'يرجى إعداد تقرير المدفوعات الشهرية', 1, '2025-11-10 09:00:00'),
(6, 1, 'التقرير جاهز ومرفق', 1, '2025-11-10 15:00:00'),
(7, 1, 'تم اكتشاف ثغرة أمنية في النظام', 1, '2025-11-15 08:00:00'),
(1, 7, 'يرجى إصلاح المشكلة فوراً', 1, '2025-11-15 08:15:00'),
(3, 1, 'الطلاب يطلبون تأجيل موعد الامتحان', 0, '2025-11-20 10:00:00'),
(1, 4, 'يرجى مراجعة درجات الطلاب المتأخرة', 0, '2025-11-25 09:00:00'),
(10, 1, 'السلام عليكم، أحتاج مساعدة في تسجيل المواد', 1, '2025-11-27 11:00:00'),
(1, 10, 'وعليكم السلام، تفضل بالمجيء إلى مكتب شؤون الطلاب', 1, '2025-11-27 11:30:00'),
(5, 2, 'تم حل مشكلة الشبكة في المعمل', 0, '2025-11-28 14:00:00');
